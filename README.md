Informs a particular channel when a user in that channel is starting a new activity e.g playing a new game (note that it is singapore time. feel free to modify the time format as needed)
